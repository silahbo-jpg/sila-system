...
const MatriculaPage = lazy(() => import('./education/MatriculaPage'));
const BoletimPage = lazy(() => import('./education/BoletimPage'));
const TransferenciaPage = lazy(() => import('./education/TransferenciaPage'));
  ...
  const services = [
    {
      ...
      description: 'Matrícula em escolas municipais',
      icon: '📚',
    ...
    },
    {
      ...
      description: 'Consulta de notas e frequência',
      icon: '📊',
      path: '/educacao/boletim',
      requiresAuth: true
    },
    {
      id: 'transferencia',
      name: 'Transferência Escolar',
      description: 'Solicitar transferência entre escolas',
      icon: '🔄',
      path: '/educacao/transferencia',
      requiresAuth: true
    },
    {
      id: 'passe-escolar',
      name: 'Passe Escolar',
      description: 'Solicitar passe de transporte escolar',
      icon: '🚌',
      path: '/educacao/passe-escolar',
      requiresAuth: true
    },
    {
      id: 'merenda',
      name: 'Programa de Merenda',
      description: 'Cadastro no programa de merenda escolar',
      icon: '🍎',
    ...
    },
    {
      ...
      description: 'Acesso aos recursos da biblioteca',
      icon: '📖',
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div className="flex-1 min-w-0">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Matrículas, boletins e serviços educacionais
              </p>
            </div>
          </div>
        </div>
